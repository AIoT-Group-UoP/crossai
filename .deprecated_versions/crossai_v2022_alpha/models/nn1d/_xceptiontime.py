...
class XceptionTime(Model):
    def __init__(self, train_data_shape, number_of_classes, xception_adaptive_size=50, xception_adapt_ws_divide=4,
        ...
        Args:
            ...
            kernel_initialize (str): The variance scaling initializer. Default value: "he_uniform".
            kernel_regularize (float or str): Regularizer to apply a penalty on the layer's kernel. Can be float or str
            in 1e-5 format.
